...
#include "L1Trigger/phase2L1TauAnalyzer/interface/P2L1TEventDisplayGenerator.h"
#include "L1Trigger/phase2L1TauAnalyzer/interface/triggerGeometryTools.hh"
...
P2L1TEventDisplayGenerator::P2L1TEventDisplayGenerator( const ParameterSet & cfg ) :
  ...
  //ecalCaloSrc_(consumes<vector <reco::CaloCluster> >(cfg.getParameter<edm::InputTag>("ecalCaloClusters")))
  {
    ...
    gROOT->ProcessLine(".L /cms/ojalvo/triggerPhaseII/CMSSW_9_1_0_pre2/src/L1Trigger/phase2L1TauAnalyzer/test/loader.C+");
